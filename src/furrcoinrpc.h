...
#ifndef _furrcoinRPC_H_
#define _furrcoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // furrcoin is not connected
...
/**
 * furrcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
