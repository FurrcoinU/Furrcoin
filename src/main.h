...
#ifndef furrcoin_MAIN_H
#define furrcoin_MAIN_H
...
static const unsigned int MAX_TX_COMMENT_LEN = 268; // furrcoin: 256 bytes + 12 little extra
...
public:
    ...
    */
    ...
    /** Amount of furrcoins spent by this transaction.
    ...
    /** Amount of furrcoins coming in to this transaction
...
public:
    ...
    {
        // Protocol switch to support p2pool at furrcoin block #9689
        ...
        // Before furrcoin block #9689 - old protocol
